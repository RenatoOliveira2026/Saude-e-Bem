export const routes = {
  ...
  protocolosPainel: "/protocolos/painel",
  protocolosRecentes: "/protocolos/recentes",
  protocolosFavoritos: "/clube/favoritos",
  ferramentas: "/ferramentas",
  biblioteca: "/biblioteca",
  recomendados: "/recomendados",
  marketplace: "/marketplace",
  obrigado: "/obrigado",
  obrigadoNewsletter: "/obrigado-newsletter",
  guia30Dias: "/guia-30-dias",
  lpHidratacao: "/lp-hidratacao",
  lpEmagrecimento: "/lp-emagrecimento",
  lpLongevidade: "/lp-longevidade",
  lpSono: "/lp-sono",
  clube: "/clube",
...
export const adminRoutes = {
  ...
  bibliotecaItemEditar: (id: string) => `/admin/biblioteca-itens/${id}/editar`,
  marketplace: "/admin/marketplace",
  marketplaceNovo: "/admin/marketplace/novo",
  marketplaceEditar: (id: string) => `/admin/marketplace/${id}/editar`,
} as const;
